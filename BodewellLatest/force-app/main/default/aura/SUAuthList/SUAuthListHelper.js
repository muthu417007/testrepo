({
    ...
    searchButtonPressFunc: function(component, event) {
        ...
        if(searchPageNewTab){
            ...
            window.location.hash = encodeURIComponent("searchString="+encodeURIComponent(component.get("v.searchString"))+"&pageNum=1&sortBy=_desc&orderBy=desc&resultsPerPage=10&exactPhrase=&withOneOrMore=&withoutTheWords=&selectedType=");
