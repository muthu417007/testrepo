...
import { ADD_PRODUCT_TO_CART_EVT, DEFAULT_QUANTITY, OUT_OF_STOCK_EVT, VALUE_CHANGED_EVT } from './constants';
 ...
 */
export default class Bwc_productQuantityAdd extends LightningElement {
     ...
     * @private
     * 
     * Replaced this field with currentQuantityInCart in handleValueChanged to use in bwc_cartPage
     */
    ...
    /**
     * Overwritten currentQuantity variable with this to get actual quantity value from bwc_cartPage component
     * @type {?number}
     * Added By Madhavi
     */
    @api
    currentQuantityInCart;  
     ...
     /**
     * Cart Item Id from parent bwc_cartPage
     * Added By Madhavi
     * @type {?String}
     */
     ...
     set cartItemId(value) {
         if (value !== undefined) {
             ...
             //console.log("Setter CartItemIdFromQAdd==>"+this._cartItemId);
 
         }
     }
     get cartItemId() {
         //console.log("Getter CartItemIdFromQAdd==>"+this._cartItemId);
    ...
    set quantity(value) {
        if (value !== undefined) {
            this.currentQuantityInCart = value;

        }
    }
    get quantity() {
        //console.log("Quantity==>"+this.currentQuantityInCart);
        return this.currentQuantityInCart;
    }
    ...
    handleValueChanged(event) {
       ...
       // console.log("valueFromQAdd==>"+value);
        this.isQuantityInvalid = false;     
        this.currentQuantityInCart = value !== undefined && value !== null ? value : DEFAULT_QUANTITY;
        this.dispatchEvent(           
            new CustomEvent(VALUE_CHANGED_EVT, {
                ...
                detail : {value, 
                         ...
                         //cartItemPrice: this.cartItemPrice},
            })
        );
