import variationAttributeLabel from '@salesforce/label/c.BWC_Search_ProductCard_variationAttribute';

/**
 * @description Computes a list of attributes from the given attribute set.
...
/**
 * @description Consolidate Experience Builder's content mapping fields with runtime product fields.
...
/**
 * @description Transform the product search query results into to a UI friendly display-data format.
...
/**
 * @description Compute the layout configuration from the given set of UI properties.
