...
/**
 * @description UI Representation for the category tree
...
/**
 * @description Tree node representation for a single category and its sub-categories.
...
/**
 * @description The facet display-data for checkbox.
 ...
 */
export default class bwc_SearchResults extends LightningElement {
    ...
    /**
     * @description Results passed from the parent searchResults cmp
    ...
    /**
     * @description The font size of the page title field.
    ...
    /**
     * @description The product fields to display in the product card component.
    ...
    /**
     * @description If an empty array - don't show any fields.
     * @type {CardContentMappingItem[]}
     * @private
     * @readonly
     * @default
    ...
    /**
     * @description Object containing the configuration settings for the card layout
    ...
    /**
     * @description Gets the computed results configuration.
    ...
    /**
     * @description Sets the custom CSS properties for components in the subtree.
     * @type {string}
     * @readonly
     * @private
     */
    get customCssProperties() {
        ...
        const css = generateStyleProperties({
        ...
        sessionStorage.setItem('productCompareCSS', css);
        return css;
    }

    /**
     * @description The size of the page as per the results, otherwise default to 20.
     * @type {number}
     * @readonly
     * @private
     * @default
    ...
    /**
     * @description The total count of product items.
     * @type {number}
     * @readonly
     * @private
     * @default
    ...
    /**
     * @description Checks if this paging control is valid to show
     * @type {boolean}
     * @readonly
     * @private
     */
    ...
    /**
     * @description Handles the `pageprevious` event.
    ...
    /**
     * @description Handles the `pagenext` event which
    ...
    /**
     * @description Handles the `pagegoto` event which
