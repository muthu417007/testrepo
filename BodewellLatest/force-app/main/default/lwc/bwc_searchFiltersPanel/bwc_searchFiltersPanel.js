 ...
 */
export default class bwc_searchFiltersPanel extends LightningElement {
    ...
    set displayData(value) {
        // console.log(`bwc_searchFiltersPanel::get displayData: ${JSON.stringify(value, null, 2)}`);
    ...
    get normalizedDisplayData() {
        ...
        console.log("displayData in searchFiltersPanel, facets",JSON.stringify(displayData),displayData.facets);
        return {
    ...
    get filteredFacets() {
        return this.normalizedDisplayData.facets.filter(facet => facet.nameOrId !== "BWC_PLPIsVisible__c");
    }
