...
export default class Bwc_productDetailTabs extends LightningElement {
...
*/
  ...
  set product(val) {
    ...
    if (val) {
      ...
      if (this._documents) {
        ...
        // const linksArray = this._documents.split("~");
        // const jsonObject = {};
      ...
      if (this._Cad) {
        this.docObjectcad(JSON.parse(this._Cad).CAD);
      }
  ...
  get getLinkStyle() {
    return this.ShowSpecifications ? 'background: transparent linear-gradient(180deg,#fffFFF00 0,#fff 70%,#DED1B1 30%);position: absolute;bottom: 0;left: 0;right: 0;display: block;padding: 100px 0 10px 0;' : 'position: relative;background: #DED1B1;padding: 10px 0;'
  }
  toggleSection() {
