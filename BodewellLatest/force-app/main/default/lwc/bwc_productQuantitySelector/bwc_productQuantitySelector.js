...
import { ERROR_RANGE_UNDERFLOW, stringOnlyHasNumbers } from 'c/bwc_commonNumberInput';
...
/**
 * @description An event fired when the value in the field changed, e.g. due to a user interaction.
...
/**
 * @description An event fired when the validity of the field changed, e.g. due to a user interaction.
...
/**
 * @description An event fired when the inventory validation takes place.
...
/**
 * @description The QuantitySelector component is a common component that can be used on all pages to show a number input field
 ...
 */
export default class bwc_ProductQuantitySelector extends LightningElement {
    ...
    /**
     * @description The numberInput does expect to get a number or undefined,
    ...
    determineOutOfStock() {
        ...
        if (inventory != null) {
           ...
           // console.log("newOutOfStock"+newOutOfStock);
        }
        if (newOutOfStock !== this._isOutOfStock) {
            this._isOutOfStock = newOutOfStock;
           // console.log("this._isOutOfStock"+this._isOutOfStock);
