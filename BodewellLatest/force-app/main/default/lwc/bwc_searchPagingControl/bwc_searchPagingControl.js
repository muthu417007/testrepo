...
/**
 * @description An event fired when the user indicates a desire to go to the previous page.
 * @event SearchPagingControl#pageprevious
 * @type {CustomEvent}
 */

/**
 * @description An event fired when the user indicates a desire to go to the next page.
 * @event SearchPagingControl#pagenext
 * @type {CustomEvent}
 */

/**
 * @description An event fired when the user indicates a desire to go to a specific page.
...
/**
 * @description A page object to render the page item.
...
/**
 * @description A simple pagination UI control for any record visualization controls.
 * @fires SearchPagingControl#pageprevious
 * @fires SearchPagingControl#pagenext
 * @fires SearchPagingControl#pagegoto
 */
export default class bwc_SearchPagingControl extends LightningElement {
    ...
    /**
     * @description The maximum quantity of numbered pages displayed to the user.
    ...
    /**
     * @description Disable previous page navigation?
     * @type {boolean}
     * @readonly
     * @private
     */
    ...
    /**
     * @description Disable next page navigation?
     * @type {boolean}
     * @readonly
     * @private
     */
    ...
    /**
     * @description only show a message if this is the last page we could possibly show while there are more results due to API limitation:
    ...
    /**
     * @description Gets page numbers as an array of objects.
     * @type {PageItem[]}
     * @readonly
     * @private
     */
    ...
    /**
     * @description Gets the symbol for range symbol.
     * @type {string}
     * @readonly
     * @private
     */
    ...
    /**
     * @description Handler for the 'click' event from the previous button.
     * @fires SearchPagingControl#pageprevious
     */
    ...
    /**
     * @description Handler for the 'click' event from the next button.
     * @fires SearchPagingControl#pagenext
     */
    ...
    /**
     * @description Handler for the 'click' event from the page number button.
