...
/**
 * @descrioption Modal for defining and handling primary and secondary actions.
 ...
 *  });
 */
export default class bwc_CommonModal extends LightningModal {
    /**
     * @description Sets the modal's title and assistive device label.
     * @type {?string}
     */
    @api
    label;
    ...
    /**
     * @description An optional message to display to the customer.
     * @type {?string}
     */
    @api
    message;
    ...
    /**
     * @description The label for the primary action. If no label is provided, the action is omitted.
     * @type {?string}
     */
    @api
    primaryActionLabel;
    ...
    /**
     * @description The label for the secondary action. If no label is provided, the action is omitted.
     * @type {?string}
     */
    @api
    ...
    /**
     * @description Whether to show the primary action.
     * @type {boolean}
     * @readonly
     * @private
     */
    ...
    /**
     * @description Whether the modal has a message/body.
     * @type {boolean}
     * @readonly
     * @private
     */
    ...
    /**
     * @description Handles the click on the primary action.
     * @readonly
     * @private
     */
    handlePrimaryAction() {
    ...
    /**
     * @description Handles the click on the secondary action.
     * @readonly
     * @private
     */
    ...
    /**
     * @description This method dispatches either the primary or secondary action click event,
