...
/**
 * @description The component takes min, max and step-size as attributes and controls what values are displayed in the
 ...
 */
export default class bwc_CommonNumberInput extends LightningElement {
    ...
    /**
     * @description The configurable minimum-size of the field. It defaults to MIN_SAFE_INTEGER but can be set to
    ...
    /**
     * @description The configurable maximum-size of the field. It defaults to MAX_SAFE_INTEGER but can be set to
     * any whole number or decimal value.
     * @type {?(string | number)}
     */
    @api
    ...
    /**
     * @description The configurable step-size of the field. It defaults to 1 but can be set to
    ...
    /**
     * @description The value field only accepts numbers. It will throw an error if a string is passed.
     * If nullish or falsy values are passed, it will do nothing.
     * @type {?(string | number)}
     */
    @api
    get value() {
        console.log("ValueFromGet==>"+this._internalValue);
        return this._internalValue;
    }
    set value(value) {
        console.log("valueFromset==>"+this.value);
    ...
    /**
     * @description Returns the defined minimum or an implicit default.
     * @type {(string | number)}
     * @private
     */
    get minOrDefault() {
    ...
    /**
     * @description Returns the defined maximum or an implicit default.
     * @type {(string | number)}
     * @private
     */
    get maxOrDefault() {
    ...
    /**
     * @description This pattern is used by the displayedInput to validate entered strings as numbers.
     * @type {string}
     * @private
     */
    get pattern() {
    ...
    /**
     * @description Visible input field type="text" that allows grouping and decimal separators to be entered
    ...
    /**
     * @description Hidden input field type="number" to validate all number related cases
     * @type {?HTMLInputElement}
     * @private
     */
    get hiddenInput() {
    ...
    /**
     * @description This is the value that should be used in the template.
     * @type {string}
     * @private
     */
    get formattedValue() {
    ...
    /**
     * @description Classes of the displayed input element
     * @type {string}
     * @private
     */
    get spanClasses() {
    ...
    /**
     * @description Modifies the value in case the increment/decrement button is clicked
     * @param {?((n?: number) => void)} modifier The modifier function
     * @private
     */
    modifyValue(modifier) {
        const lastValue = this.value;
        console.log("lastVal from commInput==>"+lastValue);
        if (modifier) {
            modifier();
        }
        ...
        const detail = {
            ...
            //cartItem id for increment & decrement
        };
        console.log("detail from commNumInp==>"+JSON.stringify(detail));
        this.dispatchEvents(detail);
        this._isValid = true;
    }

    /**
     * @description Modifies value in case of the decrement button is clicked
     * @private
     */
    decrement() {
        
        const modifier = this.hiddenInput?.stepDown.bind(this.hiddenInput);
        console.log("mOdifierFromDecrement==>"+modifier);
        this.modifyValue(modifier);
    }

    /**
     * @description Modifies value in case of the increment button is clicked
     * @private
     */
    increment() {
        const modifier = this.hiddenInput?.stepUp.bind(this.hiddenInput);
        console.log("mOdifierFromIncrement==>"+modifier);
        this.modifyValue(modifier);
    }
    ...
    handleInputChange(event) {
        console.log("EventFromCOmmonInput==>"+event.target);
    ...
    /**
     * @description The method fires the 'valuechange' event and/or the 'validitychanged' depending on whether 'isValid' has changed
    ...
    /**
     * @description This method fires the 'valuechanged' event.
    ...
    /**
     * @description This method validates the given input. This will return 'valid' for ±Infinity.
    ...
    /**
     * @description This method should be used to validate number values only. This happens, for example,
    ...
    /**
     * @description This method formats number value to localized values with grouping and decimal separator.
