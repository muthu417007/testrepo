...
/**
* @description Theme layout component for GEA Bodwell, it handles the following:
* - defines slots
* - handles different form factors 
* - handles sticky header
* @slot Customer_Service_Phone
* @slot Service_Areas
* @slot Title
* @slot Enter_ZipCode
* @slot Profile_Menu
* @slot Cart_Badge
* @slot Navigation_List_Menu
* @slot Search_Bar
...
*/
export default class bwc_BodewellCommerceLayout extends LightningElement {
    _state = {
    ...
    _handleOnScroll = this.handleOnScroll.bind(this);
    ...
    /**
     * @description Controls whether the header is frozen when the user scrolls the page
     * @type {boolean}
     */
    @api
    set isSticky(value) {
        this.updateState({ isSticky: typeof value === 'boolean' ? value : DEFAULT_IS_STICKY });
    }
    ...
    /**
     * @description handle the sticky functionality
     */
    handleOnScroll() {
        const header = this.template.querySelector('.bw-header');
